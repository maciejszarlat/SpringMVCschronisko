...
<head>
    ...
    <!-- Morris chart -->
    <link href="<c:url value="/resources/bower_components/morris.js/morris.css" />" rel="stylesheet">
    <!-- jvectormap -->
    <link href="<c:url value="/resources/bower_components/jvectormap/jquery-jvectormap.css" />" rel="stylesheet">
    <!-- Date Picker -->
    <link href="<c:url value="/resources/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css" />" rel="stylesheet">
    <!-- Daterange picker -->
    <link href="<c:url value="/resources/bower_components/bootstrap-daterangepicker/daterangepicker.css" />" rel="stylesheet">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<c:url value="/resources/dist/img/user3-128x128.jpg"/>"
                                                     class="img-circle" alt="User Image"/>
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<c:url value="/resources/dist/img/user4-128x128.jpg"/>"
                                                     class="img-circle" alt="User Image"/>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    ...
                                    <form:form action="${pageContext.request.contextPath}/logout"
                                        ...
                                        <input type="submit" class="btn btn-default btn-flat" value="Wyloguj"/>
